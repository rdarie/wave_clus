function [final_match, final_shift]= temp_match_overlap_9(wav,temp,th_o)
...
%                       end
                    ...
                    if (min_tm2<final_match(t)) & (min_tm2<final_match(t2)) &  ( min(rm2)<final_match(t) ) &  ( min(rm2)<final_match(t2) )
                ...
                if  (t~=t2) & (t~=t3) & (t2~=t3)
                    ...
                    for s = 1:ns
                        for s2 = 1:ns
                            ...
                            [tm3 rm3 res3 t_shift3]= temp_match_X(residue2(1:points,s2,t2,s,t), temp(:,t3) );
...
%                       end
                            ...
                            if (min_tm3<final_match(t)) & (min_tm3<final_match(t2)) & (min_tm3<final_match(t3))  &  ( min(rm3)<final_match(t) ) &  ( min(rm3)<final_match(t2) )  &  ( min(rm3)<final_match(t3) )
